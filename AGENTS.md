...
**Bugfix specs** — [v0.1.0 consolidation](.kiro/specs/bugfix-v0.1.0-consolidation/tasks.md) · [build warnings & Swift 6 modernization](.kiro/specs/bugfix-build-warnings-and-modernization/tasks.md) · [nonisolated unsafe audit follow-up](.kiro/specs/bugfix-nonisolated-unsafe-audit/tasks.md) · [CMTimeCode timescale guard](.kiro/specs/bugfix-cmtimecode-timescale/tasks.md) · [FingerprintIndex JSON determinism](.kiro/specs/bugfix-fingerprint-index-determinism/tasks.md) · [implemented-spec polish](.kiro/specs/bugfix-implemented-spec-polish/tasks.md) · [preview placeholder after rebuild](.kiro/specs/bugfix-preview-placeholder-after-rebuild/tasks.md) · [memory leak cache budgets](.kiro/specs/bugfix-memory-leak-investigation/tasks.md) · [CI flaky-test detection](.kiro/specs/bugfix-ci-flaky-test-detection/tasks.md)
