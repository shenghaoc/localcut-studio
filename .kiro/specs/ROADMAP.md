...
The following infrastructure was implied by browser phases referenced in the prompts (P10 markers, P14 GPU title raster, P15 keyframes, P16 audio buses, P17/24 export expansion, P19 proxy/render cache, P21 colour management, P22 caption tracks, P25 diagnostics, P26 capability tiers). P14 / P15 / P19 / P22 / P25 / P26 are now specced above. The rest are **not yet specced** for the native port and each spec calls out the ones it needs in its design `Prerequisites` section. Spec them as they become blocking; do not pre-spec speculatively.
